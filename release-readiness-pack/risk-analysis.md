...
| R4 | No v2.4 container build or target rollout evidence from this branch yet | High | Medium | Passing PR CI Docker build, immutable image digest, staged rollout and smoke test | Dev Lead | Open |
